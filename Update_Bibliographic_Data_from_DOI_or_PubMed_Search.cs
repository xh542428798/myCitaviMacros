...
public static class CitaviMacro
{
    public static async void Main()
    {
        ...
        int wait = 15;                              // timeout in seconds
	    ...
	    try
        {
            ...
            {                
				...
				DebugMacro.WriteLine(lookedUpReference.Periodical.Name);
				DebugMacro.WriteLine(lookedUpReference.Isbn);
				DebugMacro.WriteLine(lookedUpReference.Doi);
